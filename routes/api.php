...
use App\Http\Controllers\SavedPosts;
...
Route::group(['middleware' => ['auth:sanctum']], function() {
    ...
    Route::get('/savedposts', [PostController::class, 'likedPosts']); // get the saved posts
    ...
    Route::post('/saves/{id}', [SavedPostsController::class, 'saveOrUnsave']); // save or unsave back a post
});